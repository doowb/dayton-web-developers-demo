# Contributing to dayton-web-developers-demo

First and foremost, thank you! We appreciate that you want to contribute to dayton-web-developers-demo, your time is valuable, and your contributions mean a lot to us.
...
**Showing support for dayton-web-developers-demo**

Please keep in mind that open source software is built by people like you, who spend their free time creating things the rest the community can use.

Don't have time to contribute? No worries, here are some other ways to show your support for dayton-web-developers-demo:

- star the [project](https://github.com/doowb/dayton-web-developers-demo)
- tweet your support for dayton-web-developers-demo
...
- **version**: please note the version of dayton-web-developers-demo are you using
...
[so]: http://stackoverflow.com/questions/tagged/dayton-web-developers-demo